...
public class ReturnData {
    ...
    private String ctiyName = "";//城市名
    private String date = "2020-12-01";//日期
    ...
    public String getDate() {
        ...
        switch (m) {
            case 1:
                returnDateString = "Jan";
                break;
            case 2:
                returnDateString = "Feb";
                break;
            case 3:
                returnDateString = "Mar";
                break;
            case 4:
                returnDateString = "Apr";
                break;
            case 5:
                returnDateString = "May";
                break;
            case 6:
                returnDateString = "Jun";
                break;
            case 7:
                returnDateString = "Jul";
                break;
            case 8:
                returnDateString = "Aug";
                break;
            case 9:
                returnDateString = "Sept";
                break;
            case 10:
                returnDateString = "Oct";
                break;
            case 11:
                returnDateString = "Nov";
                break;
            case 12:
                returnDateString = "Dec";
                break;
        }
        if (Which == 0) {
